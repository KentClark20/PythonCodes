...
def check_my_password():
  ...
  if not any(characters.issupper() for characters in enter_password):
    ...
    print(r"Illegal character(s) found! Your Password must nt contain any of these characters / \ = ' ")
  else:
